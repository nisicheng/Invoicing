...
<body style="">
<form  action="/salesRanking/loginSalesRanking.do"  method="post">
    ...
    <div class="wrapper">
        ...
        <div class="bills cf">
            <div class="con-header">
                ...
                <hr class="hrcls">
                <div class="grid-title flex" style="text-align:center"><label style="font-size: large">销售排行表</label> </div>
            </div>
        </div>
    </div>
        ...
        <div style="position: relative;left: 50px">
            <table class="table table-striped" style="width: 1200px">
                ...
                <c:forEach items="${saless}" var="s">
                        ...
                        <tr  class="saless">
                            <td id="clientIds">${s.clientId}</td>
                            <td id="clientIdName">${s.client.clientName}</td>
                            <td id="clientName">${s.countAllForThis}</td>
                            <td id="siTotalPrice">${s.allPriceForThis}</td>
                        </tr>
