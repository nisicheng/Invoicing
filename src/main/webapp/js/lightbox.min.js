...
!function (a, b) {
    ...
    return b.defaults = {
        ...
        var b = this, c = ['<div id="lightboxOverlay" class="lightboxOverlay"></div>', '<div id="lightbox" class="lightbox">', '<div class="lb-dataContainer">', '<div class="lb-data">', '<div class="lb-details">', '<span class="lb-caption"></span>', '<span class="lb-number"></span>', "</div>", '<div class="lb-closeContainer">', '<a class="lb-close"></a>', "</div>", "</div>", "</div>", '<div class="lb-outerContainer">', '<div class="lb-container">', '<img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" />', '<div class="lb-nav">', '<a class="lb-prev" href="" ></a>', '<a class="lb-next" href="" ></a>', "</div>", '<div class="lb-loader">', '<a class="lb-cancel"></a>', "</div>", "</div>", "</div>", "</div>"].join("");
        a(c).appendTo(a("body")), this.$lightbox = a("#lightbox"), this.$overlay = a("#lightboxOverlay"), this.$outerContainer = this.$lightbox.find(".lb-outerContainer"), this.$container = this.$lightbox.find(".lb-container"), this.containerTopPadding = parseInt(this.$container.css("padding-top"), 10), this.containerRightPadding = parseInt(this.$container.css("padding-right"), 10), this.containerBottomPadding = parseInt(this.$container.css("padding-bottom"), 10), this.containerLeftPadding = parseInt(this.$container.css("padding-left"), 10), this.$overlay.hide().on("click", function () {
            return b.end(), !1
        ...
        function f(a) {
            c.album.push({link: a.attr("href"), title: a.attr("data-title") || a.attr("title")})
        }

        var c = this, d = a(window);
        d.on("resize", a.proxy(this.sizeOverlay, this)), a("select, object, embed").css({visibility: "hidden"}), this.sizeOverlay(), this.album = [];
        var h, e = 0, g = b.attr("data-lightbox");
        if (g) {
            h = a(b.prop("tagName") + '[data-lightbox="' + g + '"]');
            for (var i = 0; i < h.length; i = ++i)f(a(h[i])), h[i] === b[0] && (e = i)
        } else if ("lightbox" === b.attr("rel")) f(b); else {
            h = a(b.prop("tagName") + '[rel="' + b.attr("rel") + '"]');
            for (var j = 0; j < h.length; j = ++j)f(a(h[j])), h[j] === b[0] && (e = j)
        }
        var k = d.scrollTop() + this.options.positionFromTop, l = d.scrollLeft();
        this.$lightbox.css({
            top: k + "px",
            left: l + "px"
        ...
        var c = this, d = this.$outerContainer.outerWidth(), e = this.$outerContainer.outerHeight(), f = a + this.containerLeftPadding + this.containerRightPadding, g = b + this.containerTopPadding + this.containerBottomPadding;
